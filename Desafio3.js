const area = prompt("Você quer seguir para área de 'Gestão' ou de 'Analista'? Digite o nome da área:");
let linguagem = "";
if (area === "Analista"){
    linguagem = prompt("Você quer aprender Redes ou Desenvolver?");
}
else if (area === "Gestão"){
    linguagem = prompt("Você quer aprender Projetos ou Governança?");
}
else {
